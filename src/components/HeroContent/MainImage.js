...
function MainImage() {
  return (
    <div className='relative'>
      ...
      <Icon  width={80} height={80} className='rounded-full   animated-element    p-2 bg-gradient-to-r from-green-400 to-green-800" absolute' icon="fluent-emoji:shallow-pan-of-food" />
    </div>
